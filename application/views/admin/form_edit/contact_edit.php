...
<body class="dash p-6">
  <div class="min-h-screen flex items-center justify-center p-6">
    <div class="w-full max-w-4xl bg-white/40 backdrop-blur-2xl rounded-2xl shadow-lg p-8">
      <h2 class="text-2xl font-bold text-gray-800 mb-6">Edit Kategori Kontak</h2>
      ...
      <form action="<?= base_url('admin/update_action/' . $konten->id_konten) ?>" method="post"
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1">Nama Kategori English</label>
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1">Deskripsi in English</label>
