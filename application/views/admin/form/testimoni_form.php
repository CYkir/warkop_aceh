...
<body class="dash p-6">
  <div class="min-h-screen  flex items-center justify-center p-6">
    <div class="w-full max-w-4xl bg-white/40 backdrop-blur-2xl rounded-2xl shadow-lg p-8">
      <h2 class="text-2xl font-bold text-gray-800 mb-6">Tambah Testimoni</h2>
      ...
      <form action="<?= base_url('admin/create_action') ?>" method="post" enctype="multipart/form-data"
        ...
        <div>
          ...
          <input type="text" name="kategori" value="Testimoni"
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1">Komentar in Eglish</label>
